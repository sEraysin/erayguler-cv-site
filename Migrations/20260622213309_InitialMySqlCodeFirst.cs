...
{
    /// <inheritdoc />
    public partial class InitialMySqlCodeFirst : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Content = table.Column<string>(type: "varchar(12000)", maxLength: 12000, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DateText = table.Column<string>(type: "varchar(80)", maxLength: 80, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("MySQL:ValueGenerationStrategy", MySQLValueGenerationStrategy.IdentityColumn),
                    School = table.Column<string>(type: "varchar(160)", maxLength: 160, nullable: false),
                    Degree = table.Column<string>(type: "varchar(160)", maxLength: 160, nullable: false),
                    Field = table.Column<string>(type: "varchar(160)", maxLength: 160, nullable: false),
                    Grade = table.Column<string>(type: "varchar(40)", maxLength: 40, nullable: false),
                    DateRange = table.Column<string>(type: "varchar(80)", maxLength: 80, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Technologies = table.Column<string>(type: "varchar(240)", maxLength: 240, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Location = table.Column<string>(type: "varchar(180)", maxLength: 180, nullable: false),
                    Phone = table.Column<string>(type: "varchar(30)", maxLength: 30, nullable: false),
                    Email = table.Column<string>(type: "varchar(120)", maxLength: 120, nullable: false),
                    Language = table.Column<string>(type: "varchar(120)", maxLength: 120, nullable: false),
                    About = table.Column<string>(type: "varchar(3000)", maxLength: 3000, nullable: false),
                    ImageUrl = table.Column<string>(type: "varchar(240)", maxLength: 240, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Url = table.Column<string>(type: "varchar(240)", maxLength: 240, nullable: false),
